...
# SamMuri_2Y
date
cd /N/dc2/scratch/rzmogerr/scratchy20190816/Mm_NSE
AR=(syn1_anc)
...
do
	...
	echo ""
	echo "cd /N/dc2/scratch/rzmogerr/scratchy20190816/Mm_NSE/Sample_${i}" >> Mm_NSE_${i}_qc_clean.sh
	echo "" >> Mm_NSE_${i}_qc_clean.sh
...
#### Assembly ####
	...
	echo ""
	echo "cd /N/dc2/scratch/rzmogerr/scratchy20190816/Mm_NSE/Sample_${i}/" >> Mm_NSE_${i}_Assemble.sh
	echo "" >> Mm_NSE_${i}_Assemble.sh
	echo "echo \"BWA\" >&2" >> Mm_NSE_${i}_Assemble.sh
	echo "time bwa mem /gpfs/home/r/z/rzmogerr/Carbonate/JCVI-syn1.0_reference/Synthetic.Mycoplasma.mycoides.JCVI-syn1.0_CP002027.1.fasta Sample_${i}_R1_trimmed.fastq Sample_${i}_R2_trimmed.fastq > Sample_${i}.sam" >> Mm_NSE_${i}_Assemble.sh
   	echo "" >> Mm_NSE_${i}_Assemble.sh
	...
	echo "samtools view -bS -T /gpfs/home/r/z/rzmogerr/Carbonate/JCVI-syn1.0_reference/Synthetic.Mycoplasma.mycoides.JCVI-syn1.0_CP002027.1.fasta Sample_${i}.sam > Sample_${i}.bam" >> Mm_NSE_${i}_Assemble.sh
	echo "" >> Mm_NSE_${i}_Assemble.sh
	...
	echo ""
	echo "" >> Mm_NSE_${i}_compress.fastq.sh
	echo "cd /N/dc2/scratch/rzmogerr/scratchy20190816/Mm_NSE/Sample_${i}/" >> Mm_NSE_${i}_compress.fastq.sh
